...
Statut : v1.2 -- valide Copilot et Pilote
...
Le corpus OS contient 26 documents de natures radicalement differentes :
...
|   |-- ARCHITECTURE_CORPUS_OS_v1_2.md
|
...
*Architecture v1.2 -- ajout JONCTION_Bilaterale_OS_v0_9 -- 15.03.2026*
