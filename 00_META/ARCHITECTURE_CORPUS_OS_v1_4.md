...
Version 1.4 -- 2026-03-19
Auteur : Claude Sonnet 4.6
Statut : v1.4 -- a valider Pilote

Modification v1.3 -> v1.4 :
- RSU_phi_CSU_Jonction_v1_0.md remplace par RSU_phi_CSU_Jonction_v1_1.md
- Marqueur "revision necessaire" retire -- chantier ferme et valide
...
|-- ARCHITECTURE_CORPUS_OS_v1_4.md              (ce document)
```
...
|       Objets CSU mis a jour. Resonance spectrale RSU/CSU documentee.
|
|-- CST/
...
|   |-- ORI_C_Pancarte_Normative_v1_0.md
|   |-- ARCHITECTURE_CORPUS_OS_v1_4.md
|
...
*Architecture v1.4 -- chantiers CSU et JONCTION fermes -- 2026-03-19*
